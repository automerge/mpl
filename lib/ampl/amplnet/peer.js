  ...
  _createClass(Peer, [{
    ...
    value: function initializePeerConnection() {
      ...
      webrtc.onicecandidate = function (event) {
        if (event.candidate) {
          _this4.send_signal(event.candidate);
        }
      };
      ...
      webrtc.onconnecting = function () {
        return _this4.notice("onconnecting");
      };
      webrtc.onopen = function () {
        return _this4.notice("onopen");
      };
      webrtc.onaddstream = function () {
        return _this4.notice("onaddstream");
      };
      webrtc.onremovestream = function () {
        return _this4.notice("onremovestream");
      };
      webrtc.ondatachannel = function (event) {
        _this4.data_channel = event.channel;
        _this4.data_channel.onmessage = function (msg) {
          return _this4.process_message(msg);
        };
