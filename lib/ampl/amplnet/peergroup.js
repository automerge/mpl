...
var PeerGroup = function (_EventEmitter) {
  ...
  _createClass(PeerGroup, [{
    ...
    value: function join(signaler) {
      ...
      );var me = this.getOrCreatePeer(signaler.session, signaler.name, false, undefined
    ...
    key: 'getOrCreatePeer',
    value: function getOrCreatePeer(id, name, webrtc, handler) {
      var _this3 = this;
    ...
    key: 'beginHandshake',
    value: function beginHandshake(id, name, webrtc, handler) {
      ...
      delete this.Peers[id];
      var peer = this.getOrCreatePeer(id, name, webrtc, handler);
