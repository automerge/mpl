...
var Network = function (_EventEmitter) {
  ...
  function Network(docSet, wrtc) {
    ...
    var _this = _possibleConstructorReturn(this, (Network.__proto__ || Object.getPrototypeOf(Network)).call(this)); // XXX: remove wrtc reference
  ...
  _createClass(Network, [{
    ...
    value: function message(_message) {
      ...
      this.Peers[_message.from].receiveMsg(JSON.parse(_message.data.toString()));
    }
  }, {
