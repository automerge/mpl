  ...
  _createClass(Store, [{
    ...
    value: function openDocument(state, action) {
      ...
      if (action.docId) {
        ...
        return _automerge2.default.changeset(_automerge2.default.init(), { action: action }, function (doc) {
    ...
    value: function newDocument(state, action) {
      return _automerge2.default.changeset(_automerge2.default.init(), "new document", function (doc) {
        doc.docId = (0, _v2.default)();
      });
    }
  }, {
